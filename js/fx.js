...
document.writeln("<script type=\"text/javascript\" src=\"/templets/boke/js/fx.js\" charset=utf-8></script> <!--web2.0模块JS-->");

document.writeln("<style type=\"text/css\">@import url(/templets/boke/css/share.css);</style><!--分享模块CSS文件-->");
